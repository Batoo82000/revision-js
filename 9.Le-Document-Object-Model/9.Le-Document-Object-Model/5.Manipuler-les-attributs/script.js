...
const kittyAttibutes =kittyImg.attributes 

// console.log(kittyAttibutes);
// console.log(kittyAttibutes[0]);
// console.log(kittyAttibutes[1]);

// for (attr of kittyAttibutes) {
//     console.log(attr);
// }
...
// console.log(kittyImg.hasAttribute.src && true); // true - version sans avoir à passer par la méthode
...
//    kittyImg.removeAttribute("src");
//    kittyImg.src = ""; // ne supprime pas totalement l'attribut
