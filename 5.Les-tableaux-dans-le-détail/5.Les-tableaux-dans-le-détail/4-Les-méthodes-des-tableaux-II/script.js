...
const sum = Math.trunc(marks.reduce((acc, mark)=> acc + mark, 0) / marks.length);
...
console.log(numbers);
numbers.sort((a,b) => a + b); //tri décroissant
console.log(numbers);
...
store.sort((a,b) => a.price - b.price); //tri croissant
console.log(store);
store.sort((a,b) => a.price + b.price); //tri décroissant
console.log(store);