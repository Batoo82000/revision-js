...
const moreThan500 = companies.filter(companie => companie.revenue > 500);
...
const truthyValues2 = values.filter(values => values);
...
const filteredNames = names.filter( name => name.length > 4 && name[0] === "A");
