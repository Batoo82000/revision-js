...
for(const obj of concertRoom){
    for(const name in obj) {
        console.log(`${obj.name}, le concert commence dans 2 heures`)
    }
}

concertRoom.forEach(person => console.log(`Salut ${person.name}, le concert commence dans 2 heures`));